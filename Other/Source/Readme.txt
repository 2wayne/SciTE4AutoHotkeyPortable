...
user in an INI file next to SciTE4AutoHotkeyPortable.exe called SciTE4AutoHotkeyPortable.ini.
...
copy AppNamePortable.ini from this directory to SciTE4AutoHotkeyPortable.ini next to
SciTE4AutoHotkeyPortable.exe. The options in the INI file are as follows:
